      ...
      <el-card class="equipment-manage">
        ...
        >
          <template slot="operation" slot-scope="scope">
            ...
            <span class="button" @click="approval(scope.row)" v-if="scope.row.buttons.includes('approval')">审批</span>
            <span
              class="button"
            ...
            >删除</span>
            <span class="button" @click="release(scope.row)" v-if="scope.row.buttons.includes('release')">发布</span>
          ...
          <el-row>
            ...
            <el-col :span="11" :offset="2">
              <el-form-item label="车间名称" required="required">
                <el-input v-model="form.workshopName" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11">
              <el-form-item label="点检计划编号" required="required">
          ...
          >
              ...
              <el-form-item label="导入设备点检计划">
                <div @click="getIndex(index)">
                  <el-upload
                    ...
                    accept=".xls, .xlsx"
                  >
                    <el-button size="small" type="file">选择文件</el-button>
                  </el-upload>
                </div>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="11">
              <el-form-item label="工时" required="required">
                <el-input v-model="item.hour"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11" :offset="2">
            ...
            <el-col :span="11">
              <el-form-item label="编制日期" required="required">
                <el-date-picker v-model="item.repairTimes" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
            ...
            >
              ...
              <el-table-column align="center" width="400" label="操作" fixed="right">
                <template slot-scope="scope">
                  ...
                  <el-button
                    size="small"
                    @click.native.prevent="deleteRow(scope.$index, item.planContents)"
...
import { getDeviceName } from "../../lib/api/device";
...
export default {
  data() {
    ...
    return {
      ...
      equipmentTableList: [
        { props: "id", label: "序号"},
        { props: "no", label: "点检计划编号", width: "160px" },
        { props: "type", label: "类型" },
  ...
  methods: {
    ...
    add() {
      ...
      this.uploadHeaders.Authorization='Bearer ' + localStorage.getItem('access_token')

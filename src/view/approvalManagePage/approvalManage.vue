  ...
  export default {
    data() {
      return {
        ...
        searchFormList: [
          //  渲染头部功能区的列表
          { label: "审批类型", labelWidth:'100px',props: "workshopTeamId", value: "", placeholder:'', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          { label: "审批发起人",labelWidth:'100px', props: "workshopTeamId", value: "", placeholder:'', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          { label: "提交时间", labelWidth:'100px',props: "workshopTeamId", value: "", placeholder:'请选择状态', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          { label: "完成时间", labelWidth:'100px',props: "workshopTeamId", value: "", placeholder:'请选择状态', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          { label: "状态", labelWidth:'70px',props: "workshopTeamId", value: "", placeholder:'请选择状态', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          ],
        tableHeaderList: [{
            props: 'id',
            label: 'No.'
    ...
    methods: {
      ...
      getTableData() {
        ...
        workflowRuningManage['getLists']({ ...data,
          ...pageData
        }).then(res => {
      ...
      editDialog(row){
        workflowRuningManage['getOne']('',row.id).then(res => {
          this.form=res.data
          this.dialogVisible = true
      ...
      ok(dialogType) {
        var _self = this
        workflowRuningManage[dialogType](this.form, this.form.id).then(res => {
          this.dialogVisible = false
          this.getTableData();
          this.form = {
          name: '',

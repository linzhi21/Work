  ...
  export default {
    data() {
      return {
        ...
        authFormList:[
          //  渲染头部功能区的列表
          { label: "话题名称", key: "workshopTeamId", value: "", placeholder:'', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          { label: "话题类型",labelWidth:'120px', key: "workshopTeamId", value: "", placeholder:'', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },

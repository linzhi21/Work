  ...
  <div>
    ...
    <el-dialog :title="dialogTitleTxt" :visible.sync="dialogVisible">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="工号">
              <el-input :readonly="dialogTitleTxt=='查看'" v-model="editForm.workNo" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="姓名" :label-width="labelWidth">
              <el-input :readonly="dialogTitleTxt=='查看'" v-model="editForm.name" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="状态" :label-width="labelWidth">
              <el-select clearable :disabled="dialogTitleTxt=='查看'" v-model="editForm.enabled">
                <el-option
        ...
        <el-row v-for="(formObj, index) in editForm.userWorkshops" :key="index">
          ...
          <el-col :span="12">
            <el-form-item label="工厂" :label-width="labelWidth">
              <el-select clearable :disabled="dialogTitleTxt=='查看'" v-model="formObj.factoryId" @change="userChanged('factoryId',formObj)">
                <el-option
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="addDomain">新增工厂信息</el-button>

    ...
    data() {
      return {
        ...
        authFormList:[
          ...
          { label: "所属设备", key: "workshopTeamId", value: "", placeholder:'请选择状态', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          { label: "设备编号", key: "workshopTeamId", value: "", placeholder:'请选择状态', type:'checkbox', checkList:[{label:'状态1',id:1},{label:'状态2',id:2}] },
          ],
        authTableList: [{
            props: 'id',
            label: 'No.'
